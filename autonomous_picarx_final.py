...
def setup_camera():
    ...
    try:
        ...
        # Objekterkennung aktivieren, falls verfügbar
        try:
            Vilib.object_detect_set_model(model_type="yolo")
            Vilib.object_detect_set_clses(["person", "car", "truck", "bicycle"])
            print("Objekterkennung aktiviert.")
        except Exception as e:
            print(f"Hinweis: Objekterkennung konnte nicht aktiviert werden: {e}")
            print("Fahre ohne Objekterkennung fort.")
...
def main():
    ...
    try:
        ...
        try:
            ...
            print("Fahre ohne Fotoaufnahme fort.")
