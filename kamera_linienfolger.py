...
SPEED_FORWARD = 15     # Reduzierte Geschwindigkeit für bessere Kontrolle
SPEED_BACKWARD = 12    # Noch niedrigere Geschwindigkeit für Rückwärtsfahrt
...
def drive_forward(distance_cm, speed=15):
    ...
    # Annahme: 10 cm/s bei Geschwindigkeit 15
    estimated_time = distance_cm / (speed / 6)
...
def turn(angle, speed=12):
    ...
    try:
        ...
        # Annahme: 90° bei Geschwindigkeit 12 dauert ca. 3 Sekunden
        estimated_time = (angle / 90) * 3
...
def drive_backward(distance_cm, speed=12):
    ...
    # Geschätzte Zeit für die Distanz berechnen
    # Annahme: 8 cm/s bei Geschwindigkeit 12
    estimated_time = distance_cm / (speed / 6)
